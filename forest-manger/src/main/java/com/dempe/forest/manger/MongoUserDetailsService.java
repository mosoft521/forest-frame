...
public class MongoUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username)
        ...
        com.dempe.forest.manger.model.User user = getUserDetail(username);
    ...
    public com.dempe.forest.manger.model.User getUserDetail(String username) {
        com.dempe.forest.manger.model.User user = userService.findByName(username);
        return user;
    }
